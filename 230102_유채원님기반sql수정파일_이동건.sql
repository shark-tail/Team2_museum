...
CREATE TABLE HERITAGE_IMAGE (
	...
	CcimDesc1	VARCHAR(2000),
    ImageUrl2	VARCHAR(2000),
	CcimDesc2	VARCHAR(2000),
    ImageUrl3	VARCHAR(2000),
	CcimDesc3	VARCHAR(2000),
    ImageUrl4	VARCHAR(2000),
	CcimDesc4	VARCHAR(2000)
);
...
CREATE TABLE HERITAGE_RE (
	...
	HR_CREATE_DATE	DATETIME DEFAULT CURRENT_TIMESTAMP,
	HR_MODIFY_DATE	DATETIME DEFAULT CURRENT_TIMESTAMP,
    HR_STATUS VARCHAR(1) DEFAULT 'Y',
...
INSERT INTO EVENT VALUES(9,'외규장각 의궤, 그 고귀함의 의미','외규장각 의궤의 존재를 세상에 알리고 연구에 헌신하다 2011년 11월 23일 타계하신 고故 박병선 박사를 기리며 추모기간 동안 무료로 전시장을 개방합니다. (추모기간: 2022. 11. 21.(월) ~ 11. 27.(일) / 1주일)' ,20221101 ,20221130, '국립중앙박물관','시민','미정','서울특별시', '용산구 ',' 2022년 11월 1일(화) ~ 2023년 3월 19일(일)
...
INSERT INTO EVENT VALUES(8,'법고창신 전통문화체험','예절, 한복입기,한옥, 전통혼례, 국궁, 투호, 덕메치기, 윷놀리, 다도, 야행 ' ,20221101 ,20221130, '경주향교','일반시민 ','미정','경상북도 ', '경주시 ','11/2, 11/8, 11/9, 11/14, 11/16, 11/18');
INSERT INTO EVENT VALUES(7,'미래를 여는 인문학, 고전 다시 읽기','한의학을 품은 인문향기도시 수성X경산, 치유의 희망을 열다' ,'20221101' ,'20221130', '대구한의대학교','일반인','미정','경산북도', '경산시','개막식 2022.11.05(화) 16:00 ~ 17:30, 폐막식 2022.11.28(금) 16:00 ~17:30');
INSERT INTO EVENT VALUES(6,'찾아가는 향교',' 인성예절 및 전통놀이' ,20221101 ,20221130, '장애인작업장, 지역아동센터','장애인 및 초등학생','미정','강원도 ', '정선군 ',' 11/1, 11/2, 11/3, 11/8, 11/9, 11/10, 11/15, 11/16, 11/17 (총 9회) // 11:00~18:00 ');
INSERT INTO EVENT VALUES(5,'제 9회 세종 단오제','종부에게 배우는 종가의 음식을 알아보고 체험해 보는 프로그램' ,'20221101' ,'20221130', '세종호수공원','일반인','미정','경기도', '세종시','11/5, 11/12, 11/19, 11/26. AM11:00 - PM18:00');
INSERT INTO EVENT VALUES(4,'양주향교와 함께하는 시간여행','공연마당/체험마당/놀이마당/씨름마당/제례마당' ,20221101 ,20221130, '양주향교','시민','미정','경기도 ', '양주시 ',' 11/2, 11/5, 11/9, 11/12, 11/16, 11/23, 11/26, 11/30 (총 9회) // 10:00~16:00 ');
INSERT INTO EVENT VALUES(3,'종가의 정성','종부에게 배우는 종가의 음식을 알아보고 체험해 보는 프로그램' ,'20221101' ,'20221130', '의정공김국광종택','일반인','미정','충청남도', '논산시','11월1일-8일-15일-22일 매주 화요일 오전 09:30~12:30');
INSERT INTO EVENT VALUES(2,'에헴! 이리오너라 향교나들이','향교나들이를 통해 전통예절을 배우고 익히는 인성교육의 전당' ,20221101 ,20221130, '영천향교',' 어린이집 어린이','미정','경상북도', '영천시 ','11/1, 11/8, 11/15, 11/22, 11/29 (09:00~14:00) 화요일');
INSERT INTO EVENT VALUES(1,'자연과 문화가 흐르는 죽서루','프로그램1. 자연과 조화를 이룬 죽서루, 프로그램2. 문화가 흐르는 죽서루 (풍류 음악회)' ,'20221101' ,'20221130', '죽서루','초등학생, 시민','미정','강원도', '삼척시','프로그램1) 2022년 11월 14일 (토), 15일(일) / 13:30 ~ 16:00 프로그램2) 2022년 11월 28일 (금) / 19:30 ~ 21:00');
SELECT * FROM EVENT;
