						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0" id="result1">43</h3>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0" id="result2">68</h3>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0" id="result3">10</h3>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0" id="result4">7</h3>
								</a>
							</div>
						</div>
					</div>
