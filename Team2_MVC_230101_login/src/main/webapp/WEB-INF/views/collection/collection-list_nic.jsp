...
<link rel="stylesheet" media="screen"
	href="${path}/resources/css/collection-list.css">
		...
		<section class="mb-3">
			...
			<div class="jarallax bg-dark" style="height: 270px;">
				...
				<div
					...
					<!-- 배경박스-->
					<div
						class="content-overlay d-block justify-content-center text-center bg-white"
						...
						<div class="d-block justify-content-center text-center my-2 pt-4">
							<div class="row d-flex justify-content-center">
								<div class="col-11 d-flex align-items-center flex-column p-0">
									<div
										class="col-11 d-flex align-content-around flex-column pt-2"
										style="height: 65px;">
										<div class="d-flex justify-content-between">
											...
											<div class="d-flex justify-content-between ps-5">
												<form
													class="bg-white d-flex position-relative rounded-md-pill p-1 col-sch-form"
													style="border: 1px solid rgba(126, 126, 126, 0.521);">
													<div class="input-group input-group-lg">
														<span
															class="input-group-text text-muted rounded-pill border-0 ms-3 p-1">
															<i class="fi-search"></i>
														</span>
														<!-- 컬렉션 입력창-->
														<input
															class="form-control border-0 ms-3 p-1 col-sch-input fs-5"
															type="text" style="width: 400px;" placeholder="컬렉션 입력">
													</div>
													<div class="d-sm-flex">
														<button
															class="btn btn-primary btn-lg rounded-pill w-100 w-md-auto ms-sm-3 col-sch-btn px-4 py-0 border-0"
															style="background-color: var(- -clr-orange);"
									...
									<div class="d-block d-flex pt-2 mt-4">
										<hr class="mb-5"
											style="border: .5px solid rgba(138, 137, 137, 0.389); width: 1100px;" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0">19</h3>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0">55</h3>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0">13</h3>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-row justify-content-around py-3 px-3"
							...
							<div class="d-inline-block d-flex ">
								<a
									...
									<h3 class="icon-box-title fs-4 ps-1 mb-0">95</h3>
								</a>
							</div>
						</div>
					</div>
