...
<body>
	<div class="page">
		...
		<form id="findId-container" action="${path}/login/find-id"
			method="post">
			<div class="sec1">
				...
				<div class="onlybox">
					<input type="text" name="findName" id="findName" class="textbox2"
						required />
				</div>
				...
				<div class="onlybox">
					<input type="email" name="findEmail" id="findEmail"
						class="textbox2" required />
				</div>


				<div class="buttons">
					<input type="submit" id="findId" value="아이디 찾기" class="b"
		...
		<c:if test="${check == 0 }">
			...
			<hr
				style="margin-top: 10px; margin-bottom: 10px; background-color: var(- -clr-green); border: none; width: 100%; height: 2px;">
			<span style="text-align: center; margin-bottom: 100px;">${id}</span>
		</c:if>
